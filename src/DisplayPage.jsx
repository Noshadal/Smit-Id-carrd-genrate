    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 flex justify-center items-center p-6">
      <div className="flex flex-col lg:flex-row h-auto lg:h-[100vh] w-full justify-center items-center gap-10 lg:gap-20 p-4">
        ...
        <div className="border flex flex-col justify-center items-center md:h-[75vh] md:w-[65vw] min-h-[90vh] m-4 w-full lg:w-[27vw] p-4 bg-white rounded-lg shadow-md">
          <h1 className="text-[32px] lg:text-[40px] font-bold font-sans m-4 text-blue-600">
            SMIT
          </h1>
          ...
          {img && (
            <img
              src={img}
              className="h-[13vw] w-[13vw] object-cover m-4 border-green-700 border-4 rounded-full"
              alt="User"
            />
          )}
          <h1 className="border-b-2 border-black w-64 text-center font-sans font-semibold text-[18px] lg:text-[20px]">
            {NAME}
          </h1>
          <h1 className="border-b-2 border-black w-64 text-center text-[18px] lg:text-[20px]">
            {COURSE}
          </h1>
          <h1 className="border-b-2 border-black w-64 text-center font-sans font-semibold text-[18px] lg:text-[20px]">
            {id}
        ...
        <div className="h-auto min-h-[90vh] border-2 md:h-[75vh] md:w-[65vw] w-full lg:w-[28vw] flex flex-col justify-center px-6 lg:px-10 gap-4 p-4 bg-white rounded-lg shadow-md">
          ...
          <p className="text-center font-semibold text-[14px] lg:text-[16px] mt-4">
            Note: This card is for SMIT's premises only. If found, please return
            to SMIT.
          </p>
          <p className="border-t-2 border-black text-center mt-6 lg:mt-10 pt-2">
            Issuing authority
          </p>
        </div>
      </div>
